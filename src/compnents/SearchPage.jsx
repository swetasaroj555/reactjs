  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-6">
      ...
      <div className="flex items-center gap-4">
        <input type="text"
        placeholder="Search"
        className="flex-1 bg-gray-100 dark:gray-800 dark:border-gray-700 p-2 rounded" />
        <button type="button" 
        className="rounded-full p-2 bg-transparent border-none hover:bg-gray-200 dark:hover:bg-gray-800">
